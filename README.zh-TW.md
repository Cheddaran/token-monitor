...
| <img src=".github/assets/tools-icon/mcode.png" width="28" alt="MiniMax Code" /> | MiniMax Code | Tokscale headless capture（`~/.config/tokscale/headless/mcode/`，經 `tokscale headless mcode`） | ✅ | — | — |
